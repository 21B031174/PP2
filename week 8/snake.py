from this import d 
import pygame, sys # pygame - module, sys - system module
from pygame.locals import * 
import random, time # random - random module, time - module for time
  
#Initialzing  
pygame.init() 
  
#Setting up FPS  
FPS = 60 # frequency, 1 secundta 60 ret auysy
...
class Food(pygame.sprite.Sprite): # parent class
    def __init__(self): 
        super().__init__() 
